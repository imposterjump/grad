              ...
              <li key={`${person.name}-${index}`}>
                <div className="flex items-center gap-x-6 ">
                  <img
                    alt=""
                    src={person.imageUrl}
                    className="size-16 rounded-full w-32"
                  />
                  <div>
                ...
                <div className="space-y-6">
                  {faqs.map((faq, index) => (
                    <div key={index} className="border-b border-gray-200 pb-4">
                      <button
                        className="flex justify-between items-center w-full text-xl font-normal text-gray-600 transition duration-500 hover:text-indigo-600"
